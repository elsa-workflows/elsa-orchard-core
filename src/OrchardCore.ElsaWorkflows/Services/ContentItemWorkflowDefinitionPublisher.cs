    ...
    WorkflowDefinitionPartSerializer workflowDefinitionPartSerializer) : IWorkflowDefinitionPublisher
{
    ...
    {
        var filter = WorkflowDefinitionHandle.ByDefinitionId(definitionId, Elsa.Common.Models.VersionOptions.Latest).ToFilter();
    ...
    public async Task<WorkflowDefinition?> GetDraftAsync(string definitionId, Elsa.Common.Models.VersionOptions versionOptions, CancellationToken cancellationToken = default)
    {
