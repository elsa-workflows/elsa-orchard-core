...
public static class ElsaCollections
{
    ...
    public const string WorkflowExecutionLogRecords = "ElsaWorkflowExecutionLogRecords";
    public const string ActivityExecutionRecords = "ElsaActivityExecutionRecords";
