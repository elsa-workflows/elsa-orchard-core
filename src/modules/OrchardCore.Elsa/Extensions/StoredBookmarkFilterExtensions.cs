...
{
    public static IQuery<StoredBookmarkDocument, StoredBookmarkIndex> Apply(this BookmarkFilter filter, IQuery<StoredBookmarkDocument, StoredBookmarkIndex> query)
    {
